...
export const PreferencesSection = () => {
  ...
  // Local state for preferences since backend doesn't support it yet
  const [preferences, setPreferences] = useState({
    defaultModel: 'openai/gpt-4o',
    messageDisplay: 'comfortable' as 'compact' | 'comfortable',
    autoSave: true,
    soundEnabled: false,
  ...
  const handlePreferenceChange = async (key: keyof typeof preferences, value: any) => {
    ...
    // TODO: Save to backend when preferences API is implemented
  };
