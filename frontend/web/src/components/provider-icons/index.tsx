...
export const PROVIDER_ICONS: ProviderIcons = {
  'openai': () => (
...
export const getProviderIconKey = (modelId: string): ProviderIconKey => {
  const provider = modelId.split('/')[0]?.toLowerCase() || 'default';
  
  // Map provider names to icon keys
  const providerMap: Record<string, ProviderIconKey> = {
    'openai': 'openai',
    'anthropic': 'anthropic',
    'google': 'google',
    'meta-llama': 'meta',
