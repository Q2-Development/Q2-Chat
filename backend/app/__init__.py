...
from .models import LoginItem, PromptItem, UpdateTitleItem, UserPreferences, UpdatePreferencesItem, UpdateApiKeyItem
from .main import (
...
__all__ = [
    ...
    'LoginItem', 'PromptItem', 'UpdateTitleItem', 'UserPreferences', 'UpdatePreferencesItem', 'UpdateApiKeyItem',
    'read_root', 'post_signup', 'post_login', 'get_login_status',
    'get_logout', 'get_models', 'get_chats', 'chat', 'get_chat_title'
]